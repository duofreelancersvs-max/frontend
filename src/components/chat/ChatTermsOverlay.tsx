...
const ChatTermsOverlay = ({ onAcceptClick }: ChatTermsOverlayProps) => {
  return (
    <div className="bg-white dark:bg-[#050B15] border-t border-slate-200 dark:border-white/10 p-6 flex-shrink-0">
      <div className="flex flex-col items-center gap-3 py-4">
        ...
        <Button
          ...
          className="bg-teal hover:bg-teal-light text-white px-6 shadow-sm"
        >
