...
const AnimatedSection = ({
  ...
  return (
    ...
    >
      <SEO title="About Us | ConnectMeIndia" description="Learn more about ConnectMeIndia, our mission, and how we connect top freelancers with great clients." canonical="/about" />
      {children}
    </div>
  );
};
