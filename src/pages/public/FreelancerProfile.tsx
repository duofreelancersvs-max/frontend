    ...
    if (isAuthenticated && user?.role === "client" && id) {
      applicationService
        ...
        .then((appsRes) => {
          ...
          const isHired = apps.some(
            (app) =>
              (app.freelancerId === id ||
                app.freelancer?._id === id ||
                app.freelancer?.id === id) &&
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <AnimatedSection delay={200}>
                <div
                  id="portfolio"
                  className="bg-white dark:bg-transparent dark:glass-card rounded-2xl p-8 shadow-sm dark:shadow-none border border-slate-100 dark:border-white/5"
                >
                    ...
                    {portfolio.map((item) => {
                      ...
                      return (
                        <a
                          ...
                          className={cn(
                            "group block relative aspect-video rounded-xl overflow-hidden cursor-pointer bg-gradient-to-br transition-all duration-300",
                            style.gradient,
                          )}
                        >
